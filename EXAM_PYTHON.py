...
r1=Radiobutton (root,text="male",variable=gender, command=active).grid(row=2,column=1)
r2=Radiobutton (root,text="female",variable=gender, command=active).grid(row=2,column=2)
...
sub_btn=Button(root,text="insert",command=insert,activeforeground = "green" ,activebackground ="pink",pady=10)
...
sub_btn2=Button(root,text="delete",command=delete,activeforeground = "blue" ,activebackground ="pink",pady=10)
sub_btn2.grid(row=4,column=4)  
